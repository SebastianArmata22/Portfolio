                    ...
                    <div>
                        <ul>
                            <li>
                                ...
                                <p>Liceum Ogólnokształcące im. Jana Pawła II</p>
                                <p>Profil matematyczno-fizyczno-informatyczny</p>
                            </li>
                            <li>
                                <span>10.2018 - obecnie</span>
                                <p>Politechnika Krakowska im. Tadeusza Kościuszki</p>
                                <p>Informatyka stosowana</p>
                            </li>
                        </ul>
                    </div>
                </div>
