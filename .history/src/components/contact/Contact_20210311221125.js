        ...
        <main>
            <div>
                <div className={classes.contact_info}>
                    ...
                    <p><span>LinkedIn: </span><a href={linkedin} target="_blank" rel="noopener noreferrer">{linkedin}</a></p>
                    <p><span>GitHub: </span><a href={github} target="_blank" rel="noopener noreferrer">{github}</a></p>
